...
/// `com.sydpolk.photogoround.debug.dev`; the entitlements granted
/// `com.sydpolk.photogoround.dev`; the sandbox refused the read, and the log
/// said, every ten seconds, *the port in com.sydpolk.photogoround.debug.dev
...
/// `com.sydpolk.photogoround.claude.dev` in a `Claude` build.
///
...
struct WallpaperEntitlementsTests {
    ...
    static let entitlements: Entitlements = {
        let url = URL(filePath: #filePath)
            .deletingLastPathComponent()  // PhotoGoRoundDisplayTests
            .deletingLastPathComponent()  // Tests
            .deletingLastPathComponent()  // Shared
            .deletingLastPathComponent()  // the package root
            .appending(path: "MacOS/Wallpaper/Resources/Photo-Go-Round Wallpaper.entitlements")
