...
public enum LaunchInstall {
    ...
    static let saverPrefix = "Photo-Go-Round Screensaver"
    ...
    public static func carried(
        ...
        let agent = inside.appending(path: "Helpers/Photo-Go-Round Server.app")
        ...
        let wallpaper = inside.appending(path: "Library/Wallpaper/Photo-Go-Round Wallpaper.appex")
