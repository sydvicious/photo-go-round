...
- **Installing is a build phase, not a script's job.** The scripts call the same phases the schemes do, so CI and Xcode cannot drift apart. Syd, 2026-09-15.
