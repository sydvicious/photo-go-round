...
- **Don't install or restart the agent unless it needs it.** Every launch of the app installs and restarts its agent (since 2026-09-21, `Release App Installer.md`); on 2026-09-24 opening the app at 17:08 restarted a healthy agent and the Photos albums went unavailable. Only when the installed agent is missing, older, or not running.
