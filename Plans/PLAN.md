...
- **Phase 8** — Mac widget: WidgetKit extension for Notification Center and the desktop. **Sketched in `Widget.md`, 2026-09-19 — an idea, not a commitment.** Nothing is built, WidgetKit is imported nowhere, and every phase, family and decision in that document is a proposal Syd has not agreed to.
