...
- **No sources: "Please Add Photos"**, and the application opens its Settings window, once, when the state arrives. *It was "No Photos Selected", with "Add photos in Settings" underneath in the app only, for part of the same afternoon.*
