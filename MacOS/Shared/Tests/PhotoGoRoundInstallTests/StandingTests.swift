...
struct StandingTests {
    ...
    private let server = URL(filePath: "/Applications/Photo-Go-Round.app/Contents/Helpers/Photo-Go-Round Server.app")
    private var binary: URL { server.appending(path: "Contents/MacOS/photogoroundd") }
    private let label = "com.sydpolk.photogoround.server"
    ...
    func anotherBinaryDiffers() throws {
        let elsewhere = URL(filePath: "/Volumes/Disk Image/Photo-Go-Round.app/Contents/Helpers/Photo-Go-Round Server.app/Contents/MacOS/photogoroundd")
    ...
    private let saver = URL(filePath: "/Applications/Photo-Go-Round.app/Contents/Resources/Photo-Go-Round Screensaver.saver")
    ...
    func saverLinkedElsewhere() throws {
        let other = "/Volumes/Disk Image/Photo-Go-Round.app/Contents/Resources/Photo-Go-Round Screensaver.saver"
    ...
    func applyLinkOverADanglingLink() throws {
        ...
        defer { try? FileManager.default.removeItem(at: folder) }
        let source = folder.appending(path: "App.app/Contents/Resources/Photo-Go-Round Screensaver.saver")
        try FileManager.default.createDirectory(at: source, withIntermediateDirectories: true)
        let destination = savers.appending(path: "Photo-Go-Round Screensaver.saver")
        try FileManager.default.createSymbolicLink(
    ...
    private let appex = URL(filePath: "/Applications/Photo-Go-Round.app/Contents/Library/Wallpaper/Photo-Go-Round Wallpaper.appex")
    private let identifier = "com.sydpolk.photogoround.wallpaper.extension"
    ...
    func otherChoicesAreNot() {
        ...
        #expect(
            !WallpaperInstall.isChosen(
                identifier, store: store("com.sydpolk.photogoround.wallpaper.debug.extension")))
    }
    ...
    private func mismatch(_ running: [WallpaperInstall.Running], changed: Date?) -> String? {
        ...
        return WallpaperInstall.mismatch(
            ...
            surroundings: WallpaperInstall.Surroundings(
                directoryExists: { _ in true },
                identifierAt: { $0.contains("Debug") ? "com.sydpolk.photogoround.wallpaper.debug.extension" : identifier },
                registrations: { [] },
                changedAt: { _ in changed }))
    }
    ...
    func runningElsewhereDoesNotMatch() {
        let other = "/Volumes/Disk Image/Photo-Go-Round.app/Contents/Library/Wallpaper/Photo-Go-Round Wallpaper.appex"
    ...
    func otherConfigurationIsPassedOver() {
        let debug = WallpaperInstall.Running(
            pid: 9, appex: "/Users/x/DerivedData/Debug/Photo-Go-Round Wallpaper.appex", started: nil)
    ...
    func wallpaperElsewhere() throws {
        let other = "/Volumes/Disk Image/Photo-Go-Round.app/Contents/Extensions/Photo-Go-Round Wallpaper.appex"
    ...
    func otherConfigurationIsNotOurs() throws {
        let debug = WallpaperInstall.Registration(
            ...
            path: "/elsewhere/Photo-Go-Round Wallpaper.appex")
