...
struct WallpaperInstallTests {
    ...
    private let captured = """
             com.sydpolk.photogoround.wallpaper.claude.extension(0.1)\t28AB0040-D3D9-4207-AD43-E00A9C7903D8\t2026-09-19 22:07:04 +0000\t/Users/jazzman/.claude/build/photo-go-round/DerivedData/Build/Products/Claude/Photo-Go-Round Wallpaper Host.app/Contents/Extensions/Photo-Go-Round Wallpaper.appex
             com.sydpolk.photogoround.wallpaper.debug.extension((null))\tB97DCD84-A346-45D9-BA29-98E5B943DCC2\t2026-09-19 17:26:45 +0000\t/Users/jazzman/Library/Developer/Xcode/DerivedData/Photo-Go-Round-heayruzwkexzulcighkingfxnpek/Build/Products/Debug/Photo-Go-Round Wallpaper Host.app/Contents/Extensions/Photo-Go-Round Wallpaper.appex
        """

    private let claude =
        "/Users/jazzman/.claude/build/photo-go-round/DerivedData/Build/Products/Claude/Photo-Go-Round Wallpaper Host.app/Contents/Extensions/Photo-Go-Round Wallpaper.appex"
    private let debug =
        "/Users/jazzman/Library/Developer/Xcode/DerivedData/Photo-Go-Round-heayruzwkexzulcighkingfxnpek/Build/Products/Debug/Photo-Go-Round Wallpaper Host.app/Contents/Extensions/Photo-Go-Round Wallpaper.appex"
    ...
    func otherVendorsAreNotOurs() {
        ...
        #expect(WallpaperInstall.isOurs("com.sydpolk.photogoround.wallpaper.extension"))
        #expect(WallpaperInstall.isOurs("com.sydpolk.photogoround.wallpaper.debug.extension"))
        // Prefix alone is not enough: the host app shares it and is not an extension.
        #expect(WallpaperInstall.isOurs("com.sydpolk.photogoround.wallpaper.debug") == false)
    }
    ...
    func liveElsewhereIsUntouched() throws {
        let made = try plan(
            appex: claude,
            identifier: "com.sydpolk.photogoround.wallpaper.claude.extension",
            holds: [
                claude: "com.sydpolk.photogoround.wallpaper.claude.extension",
                debug: "com.sydpolk.photogoround.wallpaper.debug.extension",
            ],
    ...
    func bundleGoneIsRemoved() throws {
        let made = try plan(
            appex: claude,
            identifier: "com.sydpolk.photogoround.wallpaper.claude.extension",
            holds: [claude: "com.sydpolk.photogoround.wallpaper.claude.extension"],
            registered: WallpaperInstall.parseRegistrations(captured))
    ...
    func identifierChangedIsRemoved() throws {
        let made = try plan(
            ...
            holds: [
                claude: "com.sydpolk.photogoround.wallpaper.claude.extension",
                debug: "com.sydpolk.photogoround.wallpaper.extension",
            ],
            registered: WallpaperInstall.parseRegistrations(captured))
        #expect(made.toRemove.map(\.path) == [debug])
        #expect(
            made.judged.first { $0.registration.path == debug }?.verdict
                == .identifierChanged(nowHolds: "com.sydpolk.photogoround.wallpaper.extension"))
        #expect(made.describedSteps.contains { $0.contains("now holds com.sydpolk.photogoround.wallpaper.extension") })
    }
    ...
    func ourOwnIsOurs() throws {
        let made = try plan(
            appex: debug,
            identifier: "com.sydpolk.photogoround.wallpaper.debug.extension",
            holds: [
                claude: "com.sydpolk.photogoround.wallpaper.claude.extension",
                debug: "com.sydpolk.photogoround.wallpaper.debug.extension",
            ],
    ...
    func refusesMissingBundle() {
        let missing = URL(filePath: "/nowhere/Photo-Go-Round Wallpaper.appex")
