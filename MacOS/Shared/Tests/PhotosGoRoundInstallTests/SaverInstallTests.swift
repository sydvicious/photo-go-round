...
struct SaverInstallTests {
    ...
    @Test(
        ...
        arguments: [
            "Photos-Go-Round Screensaver",
            "Photos-Go-Round Screensaver (Debug)",
            "Photos-Go-Round Screensaver (Claude)",
        ])
    ...
    func replacesOnlyItsOwnName() throws {
        let source = URL(filePath: "/build/Photos-Go-Round Screensaver (Claude).saver")
        let othersInstalled = [
            savers.appending(path: "Photos-Go-Round Screensaver.saver"),
            savers.appending(path: "Photos-Go-Round Screensaver (Debug).saver"),
        ]
        let plan = try SaverInstall.plan(
            for: source, into: savers,
    ...
    func replacingIsKnown() throws {
        let source = URL(filePath: "/build/Photos-Go-Round Screensaver (Debug).saver")
        let installed = savers.appending(path: "Photos-Go-Round Screensaver (Debug).saver")
    ...
    func onlyRunningHosts() throws {
        let source = URL(filePath: "/build/Photos-Go-Round Screensaver.saver")
    ...
    func refusals() {
        let missing = URL(filePath: "/build/Photos-Go-Round Screensaver.saver")
        ...
        let app = URL(filePath: "/build/Photos-Go-Round.app")
