...
- *Saying the agent is not there* — **done.** The window title gains the trouble's words — `Photo-Go-Round - Waiting for Photos` since 2026-09-16, `Photo-Go-Round - Photo-Go-Round Is Not Running` from 2026-09-09, and `Photo-Go-Round - No agent` before that — and the photograph dims behind a flat grey at three-tenths.
